...
2021-12-26: Added explanatory images to the introduction. More thoughts on naming and minor text clarifications.
...
To clarify what is new, the addition is here called \tcode{std::multi_nth_element}, but is proposed to go as new overloads for \tcode{std::nth_element}. 
